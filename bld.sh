...
# OS X 64-bit App
cp -R node-webkit/node-webkit-v0.11.3-osx-x64/node-webkit.app output/mac64/TiddlyWiki.app
...
# OS X 32-bit App
cp -R node-webkit/node-webkit-v0.11.3-osx-ia32/node-webkit.app output/mac32/TiddlyWiki.app
...
# Windows 64-bit App
cp -R node-webkit/node-webkit-v0.11.3-win-x64/* output/win64
cp -R source/* output/win64

# Windows 32-bit App
cp -R node-webkit/node-webkit-v0.11.3-win-ia32/* output/win32
cp -R source/* output/win32

# Linux 64-bit App
cp -R node-webkit/node-webkit-v0.11.3-linux-x64/* output/linux64
cp -R source/* output/linux64

# Linux 32-bit App
cp -R node-webkit/node-webkit-v0.11.3-linux-ia32/* output/linux32
